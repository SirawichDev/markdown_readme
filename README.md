...
### Projects
* เป็นคบ้ายๆการทำ to do ,ระบบ agile 
* มีสาม ฟังค์ชัน To do(คาดว่าจะทำ ), In progess(ทำอยู่) , Done (เสร็จแล้ว)

### integration & services
* ทำหน้าที่ในการตรวจสอบว่า code ทำงานถูกต้องมั้ย ผ่าน api ต่างๆ อัพเสร็จทำtestเสร็จก็ไปเปลี่ยนแปลงหน้าเว็บได้เลย
* ทำแทนที่ SSH 